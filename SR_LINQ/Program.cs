...
namespace SR_LINQ
{
    ...
    class MainClass
    {
        private static string[] favouriteCategories = {
                "Beverages",
                "Condiments",
                "Vegetables",
                "Dairy Products",
        ...
        public static void Main(string[] args)
        {
            ...
            // Вывести на экран минимальное и максимальное значение итоговой цены (итог = цена за штуку * кол-во)
            // внутри каждой из любимых категорий (см. массив выше)

            // Вывести на экран топ 5 категорий, в которых самое большое количество различных
            // наименований продуктов, и само количество

            // Вывести на экран общую итоговую стоимость всех продуктов (итог = цена за штуку * кол-во)

            // По каждой из любимых категорий вывести на экран количество единиц продуктов (UnitsInStock),
            // чья цена за единицу товара (UnitPrice) не превосходит среднее значение по этой категории

            // Отсортировать продукты в возрастающем порядке итоговой цены (итог = цена за штуку * кол-во),
            // затем отсортировать в порядке возрастания количества гласных букв в имени продукта,
            // затем по названию категории (в обратном алфавитном порядке).
            // Вывести на экран три первых и три последних продукта из полученного списка

            // Сгруппировать все продукты по количеству пробелов в их названии.
            // Для каждой полученной группы посчитать количество вошедших в нее любимых категорий,
            // и среднее значение цены за единицу товара
        }
    }
